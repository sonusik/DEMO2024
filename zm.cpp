...
int main()
{
	...
	COORD c1; // объект для хранения координат
	HANDLE h1 = GetStdHandle(STD_OUTPUT_HANDLE); // создание хендла потока вывода
	CONSOLE_CURSOR_INFO cci1 = { sizeof(cci1), false }; // создание параметров на отображение курсора
	...
	for (int y = 0; y < height; y++) // стандартный двойной цикл на отрисовку рамки
	{
		...
		c1.X = 55;
	c1.Y = 0;
	SetConsoleCursorPosition(h1, c1); // отправка туда курсора
	cout << "Score = " << score;	
